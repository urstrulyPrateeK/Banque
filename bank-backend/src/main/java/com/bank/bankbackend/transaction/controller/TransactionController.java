package com.bank.bankbackend.transaction.controller;

import com.bank.bankbackend.transaction.dto.*;
import com.bank.bankbackend.transaction.service.TransactionService;
    ...
    public ResponseEntity<Page<TransactionResponse>> getAllTransactions(
        ...
        try {
            Page<TransactionResponse> transactions = transactionService.getTransactions(
                    accountId, type, status, startDate, endDate, minAmount, maxAmount, pageable
            );
