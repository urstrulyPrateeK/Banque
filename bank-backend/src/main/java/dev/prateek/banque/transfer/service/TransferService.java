package dev.prateek.banque.transfer.service;
...
import dev.prateek.banque.transfer.dto.*;
import dev.prateek.banque.transfer.entity.RecurringTransfer;
import dev.prateek.banque.transfer.entity.Transfer;
import dev.prateek.banque.transfer.repository.RecurringTransferRepository;
import dev.prateek.banque.transfer.repository.TransferRepository;
...
public class TransferService {
    ...
    public TransferResponse internalTransfer(@Valid InternalTransferRequest request) {
        try {
            ...
            // SERIALIZABLE keeps concurrent transfers from double-spending the same balance.
    ...
    private void processTransfer(Transfer transfer, Account source, Account destination) {
        ...
        balanceCacheService.evictAccountBalance(source.getId());
        balanceCacheService.evictAccountBalance(destination.getId());
